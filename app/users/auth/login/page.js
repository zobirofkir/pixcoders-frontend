    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      <div className="container mx-auto px-4 py-16">
        <div className="flex flex-col md:flex-row items-center justify-center min-h-[80vh]">
          {/* Left side - Form */}
          <div className="w-full md:w-1/2 lg:w-1/3 bg-white rounded-2xl shadow-xl p-8 md:p-10">
            <div className="mb-8 text-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome Back</h1>
              <p className="text-gray-600">Sign in to access your PixCoders account</p>
            </div>
          ...
          <div className="hidden md:flex md:w-1/2 lg:w-2/5 items-center justify-center p-12">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Join the world's leading companies</h2>
              <p className="text-xl text-gray-600 mb-8 max-w-lg">
                Access a network of top talent and take your projects to the next level with PixCoders.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                {[1, 2, 3, 4, 5, 6].map((item) => (
                  <div key={item} className="h-16 flex items-center justify-center">
