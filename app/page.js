      ...
      <main className="max-w-4xl w-full text-center">
        ...
        >
          ...
          >
            ...
            <a 
              className="px-8 py-4 border-2 border-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 transform"
            >
          ...
          <div id="about" className="mt-16 bg-white rounded-2xl shadow-xl p-8 mb-16">
